...
OSM.Style.StyleMap = OpenLayers.Class(OpenLayers.StyleMap, {
    ...
    physical: ['landuse', 'amenity', 'highway', 'leisure', 'natural', 'route', 'boundary', 'man_made',
            'power', 'railway', 'waterway', 'cycleway', 'barrier', 'place', 'historic', 'tourism', 'shop', 'aerialway',
            'mountain_pass', 'aeroway', 'military', 'geological', 'traffic_sign', 'building', 'fixme', 'FIXME'],
    pointPhysicalStyles: null,
    pointSubStyles: null,
    linePhysicalStyles: null,
    lineSubStyles: null,
    areaPhysicalStyles: null,
    areaSubStyles: null,

    initialize: function(style, options) {
        this.pointPhysicalStyles = {};
        this.pointSubStyles = {};
        this.linePhysicalStyles = {};
        this.lineSubStyles = {};
        this.areaPhysicalStyles = {};
        this.areaSubStyles = {};
...
/*        for (phKey in map) {
    ...
    createSymbolizer: function(feature, intent) {
        ...
        if (style !== null) {
            // from cloned base
            style = OpenLayers.Util.extend(OpenLayers.Util.extend({}, baseStyle), style);
        }
                ...
                if (OpenLayers.Util.indexOf(this.physical, key) < 0) {
                    ...
                    if (subStyle !== null) {
                        if (style !== null) {
                            ...
                            // from cloned base
                            style = OpenLayers.Util.extend(OpenLayers.Util.extend({}, baseStyle), subStyle);
                        }
                        break;
                    }
                }
