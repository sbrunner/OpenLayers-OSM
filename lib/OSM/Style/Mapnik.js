...
OSM.Style.Mapnik = {
    ...
    */
        ...
        OSM.Style.Utils.addStroke(styleMap, 'highway', 'path', 'green', 3);

        OSM.Style.Utils.addStroke(styleMap, 'highway', 'motorway', '#808bc0', 27);
        OSM.Style.Utils.addStroke(styleMap, 'highway', 'motorway_link', '#808bc0', 21);
        OSM.Style.Utils.addStrokeArea(styleMap, 'highway', 'trunk', '#7fc97f', 24);
        OSM.Style.Utils.addStrokeArea(styleMap, 'highway', 'trunk_link', '#7fc97f', 18);
        OSM.Style.Utils.addStrokeArea(styleMap, 'highway', 'primary', '#e46d71', 21);
        OSM.Style.Utils.addStrokeArea(styleMap, 'highway', 'primary_link', '#e46d71', 15);
        OSM.Style.Utils.addStrokeArea(styleMap, 'highway', 'secondary', '#fdbf6f', 18);
        OSM.Style.Utils.addStrokeArea(styleMap, 'highway', 'secondary_link', '#fdbf6f', 15);
        OSM.Style.Utils.addStrokeArea(styleMap, 'highway', 'tertiary', '#fefeb3', 15);
        OSM.Style.Utils.addStrokeArea(styleMap, 'highway', 'unclassified', '#dddddd', 12);
        OSM.Style.Utils.addStroke(styleMap, 'highway', 'road', '#dddddd', 12);
        OSM.Style.Utils.addStrokeArea(styleMap, 'highway', 'residential', '#dddddd', 12);
        OSM.Style.Utils.addStrokeArea(styleMap, 'highway', 'living_street', '#cccccc', 9);
        OSM.Style.Utils.addStrokeArea(styleMap, 'highway', 'service', '#dddddd', 9);
        OSM.Style.Utils.addStroke(styleMap, 'highway', 'track', '#c39947', 6);
        OSM.Style.Utils.addStrokeArea(styleMap, 'highway', 'pedestrian', '#999999', 6);
        OSM.Style.Utils.addStroke(styleMap, 'highway', 'raceway', '#dddddd', 6);
        OSM.Style.Utils.addStroke(styleMap, 'highway', 'services', '#dddddd', 6);
        OSM.Style.Utils.addStroke(styleMap, 'highway', 'path', '#222222', 3);
        OSM.Style.Utils.addStroke(styleMap, 'highway', 'cycleway', '#222222', 3);
        OSM.Style.Utils.addStroke(styleMap, 'highway', 'footway', '#222222', 3);
        OSM.Style.Utils.addStroke(styleMap, 'highway', 'bridleway', '#222222', 3);
        OSM.Style.Utils.addStroke(styleMap, 'highway', 'byway', '#222222', 3);
        OSM.Style.Utils.addStroke(styleMap, 'highway', 'steps', '#222222', 5, 'dot');
        ...
        OSM.Style.Utils.addArea(styleMap, 'building', '.+', '#bca9a9', 1);
