...
OSM.Style.Mapnik = {
    getStyleMap: function(styleMap) {
        ...
        OSM.Style.Utils.addPoint(styleMap, 'religion', 'christian', 'app/images/josm/religion/church.png', 9);
        ...
        OSM.Style.Utils.addPoint(styleMap, 'religion', 'sikh', 'app/images/josm/religion/sikhism.png', 12);
        ...
        styleMap.addUniqueShapeValueRules("default", 'area', "landuse", {
        ...
        styleMap.addUniqueShapeValueRules("default", 'area', "natural", {
        ...
        OSM.Style.Utils.addAreaLabel(styleMap, 'building', '.+', '#bca9a9', 0.9, 'addr:housenumber');
        OSM.Style.Utils.addAreaLabel(styleMap, 'building', '.+', '#bca9a9', 0.9, 'addr:housename');
